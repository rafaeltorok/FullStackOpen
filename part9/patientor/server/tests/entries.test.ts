...
describe("POST route", () => {
  test("A new Hospital entry can be added", async () => {
    ...
    assert.strictEqual(
      patientInfo.entries[0].description,
      hospitalEntry.description,
    );
    assert.strictEqual(
      patientInfo.entries[0].specialist,
      hospitalEntry.specialist,
    );
    assert.deepStrictEqual(
      patientInfo.entries[0].diagnosisCodes,
      hospitalEntry.diagnosisCodes,
    );
    assert.deepStrictEqual(
      patientInfo.entries[0].discharge,
  ...
  test("A new HealthCheck entry can be added", async () => {
    ...
    assert.strictEqual(
      patientInfo.entries[0].healthCheckRating,
  ...
  test("A new Occupational Healthcare entry can be added", async () => {
    ...
    assert.strictEqual(
      patientInfo.entries[0].employerName,
      occupationalEntry.employerName,
    );
    assert.deepStrictEqual(
      patientInfo.entries[0].diagnosisCodes,
    ...
    assert.deepStrictEqual(
      patientInfo.entries[0].sickLeave,
  ...
  test("The diagnosisCodes field is optional across all entry types", async () => {
    ...
    assert.strictEqual(
      patientInfo.entries[1].description,
      healthCheckEntry.description,
    );
    assert.strictEqual(
      patientInfo.entries[1].specialist,
      healthCheckEntry.specialist,
    );
    assert.strictEqual(
      patientInfo.entries[1].healthCheckRating,
      healthCheckEntry.healthCheckRating,
    );
    ...
    assert.strictEqual(
      patientInfo.entries[2].description,
      occupationalEntry.description,
    );
    assert.strictEqual(
      patientInfo.entries[2].specialist,
      occupationalEntry.specialist,
    );
    assert.strictEqual(
      patientInfo.entries[2].employerName,
      occupationalEntry.employerName,
    );
    assert.deepStrictEqual(
      patientInfo.entries[2].sickLeave,
      occupationalEntry.sickLeave,
    );
